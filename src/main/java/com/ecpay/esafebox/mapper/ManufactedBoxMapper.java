...
public interface ManufactedBoxMapper {
	@Mappings({
		...
		@Mapping(target = "boxCreatedDate", source = "box.created"),
	})
	ManufactedBoxDto toBoxDto(Box box);
	List<ManufactedBoxDto> toBoxDtos(List<Box> boxs);
}
